...
2. 🌟 you can use ```run.sh``` to execute and check format, but the result can't passed check
3. you can change evaluation method by modify the rageval version in ```run_evaluate.sh```
