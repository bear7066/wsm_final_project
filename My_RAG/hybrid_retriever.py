...
from retriever import Retriever as BM25Retriever
...
class HybridRetriever:
    ...
    def __init__(self, chunks, language="en", bm25_weight=0.5, vector_weight=0.5, embedding_model=None):
        """
...
def create_retriever(chunks, language, bm25_weight=0.5, vector_weight=0.5, embedding_model=None):
    """
